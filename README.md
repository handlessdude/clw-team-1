...
***
### Инструкця для пользователя
_При наведении курсора на верхнюю область веб-приложения появляется навбар, в котором есть возможность сменить роль (пользователь или ученик)_
![Example](navbar.jpg)
